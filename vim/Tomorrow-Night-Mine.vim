...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("sqlVariable", s:aqua, "", "")
    call <SID>X("sqlType", s:yellow, "", "")
    call <SID>X("sqlKeyword", s:orange, "", "")
    call <SID>X("sqlOperator", s:blue, "", "")
    call <SID>X("sqlSpecial", s:red, "", "")

    " MySQL
    call <SID>X("mysqlStatement", s:purple, "", "")
    call <SID>X("mysqlVariable", s:aqua, "", "")
    call <SID>X("mysqlType", s:yellow, "", "")
    call <SID>X("mysqlKeyword", s:orange, "", "")
    call <SID>X("mysqlOperator", s:blue, "", "")
    call <SID>X("mysqlSpecial", s:red, "", "")
